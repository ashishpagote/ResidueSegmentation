...
parser.add_argument('--epochs', action='store', type=int, default=6000, help='Total Number of epochs to train')
parser.add_argument('--exp_name', action='store', type=str, default='unet_resnet18_6', help='Name of experiment')
parser.add_argument('--model', action='store', type=str, default='unet', help='Name of model')
parser.add_argument('--backbone', action='store', type=str, default='resnet18', help='Name of model')
...
image_path = './Cross_Validation/Images'
mask_path = './Cross_Validation/Masks'
...
files = glob('/gpfs/data1/cmongp/ashishp/ResidueSegementation3/Cross_Validation/Masks/Validation/*')
for f in files:
    os.remove(f)
files = glob('/gpfs/data1/cmongp/ashishp/ResidueSegementation3/Cross_Validation/Masks/Training/*')
for f in files:
    os.remove(f)
files = glob('/gpfs/data1/cmongp/ashishp/ResidueSegementation3/Cross_Validation/Images/Validation/*')
for f in files:
    os.remove(f)
files = glob('/gpfs/data1/cmongp/ashishp/ResidueSegementation3/Cross_Validation/Images/Training/*')
for f in files:
    os.remove(f)

import shutil
os.chdir('/gpfs/data1/cmongp/ashishp/ResidueSegementation3/All_Images/Images')
source=os.listdir("/gpfs/data1/cmongp/ashishp/ResidueSegementation3/All_Images/Images/")
for files in source:
    if files.startswith(fold):
        shutil.copy(files, '/gpfs/data1/cmongp/ashishp/ResidueSegementation3/Cross_Validation/Images/Validation/')
    else:
        shutil.copy(files, '/gpfs/data1/cmongp/ashishp/ResidueSegementation3/Cross_Validation/Images/Training/')

os.chdir('/gpfs/data1/cmongp/ashishp/ResidueSegementation3/All_Images/Masks_inverted')
source=os.listdir("/gpfs/data1/cmongp/ashishp/ResidueSegementation3/All_Images/Masks_inverted/")
for files in source:
    if files.startswith(fold):
        shutil.copy(files, '/gpfs/data1/cmongp/ashishp/ResidueSegementation3/Cross_Validation/Masks/Validation/')
    else:
        shutil.copy(files, '/gpfs/data1/cmongp/ashishp/ResidueSegementation3/Cross_Validation/Masks/Training/')

os.chdir('/gpfs/data1/cmongp/ashishp/ResidueSegementation3')
